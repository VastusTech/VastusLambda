...
public class UserDatabaseActionBuilder {
    ...
    public static DatabaseAction updateName(String id, String itemType, String name) throws Exception {
        return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "name", new AttributeValue(name), false, PUT);
    }

    public static DatabaseAction updateGender(String id, String itemType, String gender) throws Exception {
        return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "gender", new AttributeValue(gender), false, PUT);
    }

    public static DatabaseAction updateBirthday(String id, String itemType, String birthday) throws Exception {
        return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "birthday", new AttributeValue(birthday), false, PUT);
    }

    public static DatabaseAction updateEmail(String id, String itemType, String email) throws Exception {
        return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "email", new AttributeValue(email), false, PUT);
    }

    public static DatabaseAction updateStripeID(String id, String itemType, String stripeID) throws Exception {
        return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "stripeID", new AttributeValue(stripeID), false, PUT);
    }

    public static DatabaseAction updateProfileImagePath(String id, String itemType, String profileImagePath) throws
            Exception {
        return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "profileImagePath", new AttributeValue(profileImagePath),
                false, PUT);
    }

    public static DatabaseAction updateAddProfileImagePath(String id, String itemType, String profileImagePath) throws
            Exception {
        return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "profileImagePaths", new AttributeValue(profileImagePath),
                false, ADD);
    }
    ...
    public static DatabaseAction updateAddScheduledWorkout(String id, String itemType, String workout, boolean
        ...
        if (ifWithCreate) {
            return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "scheduledWorkouts", null, true, ADD);
        }
        else {
            return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "scheduledWorkouts", new AttributeValue(workout),
                        true, ADD);
        }
    }
    ...
    public static DatabaseAction updateRemoveScheduledWorkout(String id, String itemType, String workout) throws
            Exception {
        // TODO REFUNDS?
        return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "scheduledWorkouts", new AttributeValue(workout), false,
                DELETE);
    }

    public static DatabaseAction updateAddCompletedWorkout(String id, String itemType, String workout) throws Exception {
        return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "completedWorkouts", new AttributeValue(workout), false,
                ADD);
    }
    ...
    public static DatabaseAction updateAddScheduledTime(String id, String itemType, String time, CheckHandler checkHandler)
        ...
        if (checkHandler == null) {
            ...
            return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "scheduledTimes", new AttributeValue(time),
            ...
            return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "scheduledTimes", new AttributeValue(time), false, ADD,
                    checkHandler);
        }
    }
    ...
    public static DatabaseAction updateAddReviewBy(String id, String itemType, String review, boolean ifWithCreate)
            throws Exception {
        if (ifWithCreate) {
            return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "reviewsBy", null, true, ADD);
        }
        else {
            return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "reviewsBy", new AttributeValue(review),
                        true, ADD);
        }
    }

    public static DatabaseAction updateRemoveReviewBy(String id, String itemType, String review) throws Exception {
        return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "reviewsBy", new AttributeValue(review), false, DELETE);
    }

    public static DatabaseAction updateAddReviewAbout(String id, String itemType, String review, boolean ifWithCreate)
            throws Exception {
        if (ifWithCreate) {
            return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "reviewsAbout", null, true, ADD);
        }
        else {
            return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "reviewsAbout", new AttributeValue(review),
                        true, ADD);
        }
    }
    ...
    public static DatabaseAction updateRemoveReviewAbout(String id, String itemType, String review) throws
            Exception {
        return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "reviewsAbout", new AttributeValue(review), false, DELETE);
    }

    public static DatabaseAction updateFriendlinessRating(String id, String itemType, String rating) throws Exception {
        return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "friendlinessRating", new AttributeValue(rating), false, PUT);
    }

    public static DatabaseAction updateEffectivenessRating(String id, String itemType, String rating) throws Exception {
        return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "effectivenessRating", new AttributeValue(rating), false, PUT);
    }

    public static DatabaseAction updateReliabilityRating(String id, String itemType, String rating) throws Exception {
        return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "reliabilityRating", new AttributeValue(rating), false, PUT);
    }

    public static DatabaseAction updateBio(String id, String itemType, String bio) throws Exception {
        return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "bio", new AttributeValue(bio), false, PUT);
    }
    ...
    public static DatabaseAction updateAddFriend(String id, String itemType, String friend, boolean ifAccepting) throws
        ...
        if (ifAccepting) {
            return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "friends", new AttributeValue(friend),
                    false, ADD, new CheckHandler() {
                @Override
                public String isViable(DatabaseItem newItem) throws Exception {
    ...
    public static DatabaseAction updateAddFriendRequest(String id, String itemType, String friend) throws Exception {
        return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "friendRequests", new AttributeValue(friend),
                false, ADD, new CheckHandler() {
            @Override
            public String isViable(DatabaseItem newItem) throws Exception {
    ...
    public static DatabaseAction updateAddChallenge(String id, String itemType, String challenge, boolean ifWithCreate)
            throws Exception {
        if (ifWithCreate) {
            return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "challenges", null, true, ADD);
        }
        else {
            return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "challenges", new AttributeValue(challenge),
                    false, ADD);
        }
    }

    public static DatabaseAction updateRemoveChallenge(String id, String itemType, String challenge) throws Exception {
        return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "challenges", new AttributeValue(challenge), false,
                DELETE);
    }

    public static DatabaseAction updateAddCompletedChallenge(String id, String itemType, String challenge) throws
            Exception {
        return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "completedChallenges", new AttributeValue(challenge), false,
                ADD);
    }
    ...
    public static DatabaseAction updateAddOwnedChallenge(String id, String itemType, String challenge, boolean
            ifWithCreate) throws Exception {
        if (ifWithCreate) {
            return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "ownedChallenges", null, true, ADD);
        }
        else {
            return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "ownedChallenges", new AttributeValue(challenge),
                    true, ADD);
        }
    }
    ...
    public static DatabaseAction updateRemoveOwnedChallenge(String id, String itemType, String challenge) throws
            Exception {
        return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "ownedChallenges", new AttributeValue(challenge), false,
                DELETE);
    }

    public static DatabaseAction updateAddInvitedChallenge(String id, String itemType, String challenge) throws
            Exception {
        return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "invitedChallenges", new AttributeValue(challenge), false,
                ADD);
    }
    ...
    public static DatabaseAction updateAddChallengeWon(String id, String itemType, String challenge) throws Exception {
        return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "challengesWon", new AttributeValue(challenge), false, ADD);
    }

    public static DatabaseAction updateRemoveChallengeWon(String id, String itemType, String challenge) throws Exception {
        return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "challengesWon", new AttributeValue(challenge), false, DELETE);
    }

    public static DatabaseAction updateAddScheduledEvent(String id, String itemType, String event, boolean ifWithCreate) throws
            Exception {
        if (ifWithCreate) {
            return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "scheduledEvents", null, true, ADD);
        }
        else {
            return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "scheduledEvents", new AttributeValue(event), false, ADD);
        }
    }

    public static DatabaseAction updateRemoveScheduledEvent(String id, String itemType, String event) throws Exception {
        return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "scheduledEvents", new AttributeValue(event), false,
                DELETE);
    }

    public static DatabaseAction updateAddCompletedEvent(String id, String itemType, String event) throws Exception {
        return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "completedEvents", new AttributeValue(event), false,
                ADD);
    }
    ...
    public static DatabaseAction updateAddOwnedEvent(String id, String itemType, String event, boolean ifWithCreate) throws Exception {
        if (ifWithCreate) {
            return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "ownedEvents", null, true,
                    ADD);
        }
        else {
            return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "ownedEvents", new AttributeValue(event), false,
                    ADD);
        }
    }
    ...
    public static DatabaseAction updateAddInvitedEvent(String id, String itemType, String event) throws
            Exception {
        return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "invitedEvents", new AttributeValue(event), false, ADD, new
                CheckHandler() {
                    @Override
                    public String isViable(DatabaseItem newItem) throws Exception {
    ...
    public static DatabaseAction updateRemoveInvitedEvent(String id, String itemType, String event) throws Exception {
        return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "invitedEvents", new AttributeValue(event), false, DELETE);
    }

    public static DatabaseAction updateAddSentInvite(String id, String itemType, String invite, boolean ifWithCreate)
            throws Exception {
        if (ifWithCreate) {
            return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "sentInvites", null, true, ADD);
        }
        else {
            return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "sentInvites", new AttributeValue(invite), false, ADD);
        }
    }

    public static DatabaseAction updateRemoveSentInvite(String id, String itemType, String invite) throws Exception {
        return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "sentInvites", new AttributeValue(invite), false, DELETE);
    }

    public static DatabaseAction updateAddReceivedInvite(String id, String itemType, String invite, boolean
            ifWithCreate) throws Exception {
        if (ifWithCreate) {
            return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "receivedInvites", null, true, ADD);
        }
        else {
            return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "receivedInvites", new AttributeValue(invite), false, ADD);
        }
    }

    public static DatabaseAction updateRemoveReceivedInvite(String id, String itemType, String invite) throws Exception {
        return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "receivedInvites", new AttributeValue(invite),
                false, DELETE);
    }
    ...
    public static DatabaseAction updateAddPost(String id, String itemType, String post, boolean ifWithCreate) throws
            Exception {
        if (ifWithCreate) {
            return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "posts", null, true, ADD);
        }
        else {
            return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "posts", new AttributeValue(post), false, ADD);
        }
    }

    public static DatabaseAction updateRemovePost(String id, String itemType, String post) throws Exception {
        return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "posts", new AttributeValue(post), false, DELETE);
    }

    public static DatabaseAction updateAddComment(String id, String itemType, String comment, boolean ifWithCreate)
            throws Exception {
        if (ifWithCreate) {
            return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "comments", null, true, ADD);
        }
        else {
            return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "comments", new AttributeValue(comment), false, ADD);
        }
    }

    public static DatabaseAction updateRemoveComment(String id, String itemType, String comment) throws Exception {
        return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "comments", new AttributeValue(comment), false, DELETE);
    }

    public static DatabaseAction updateAddGroup(String id, String itemType, String group, boolean ifWithCreate)
            throws Exception {
        if (ifWithCreate) {
            return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "groups", null, true, ADD);
        }
        else {
            return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "groups", new AttributeValue(group), false, ADD);
        }
    }

    public static DatabaseAction updateRemoveGroup(String id, String itemType, String group) throws Exception {
        return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "groups", new AttributeValue(group), false, DELETE);
    }

    public static DatabaseAction updateAddInvitedGroup(String id, String itemType, String group) throws Exception {
        return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "invitedGroups", new AttributeValue(group), false, ADD);
    }

    public static DatabaseAction updateRemoveInvitedGroup(String id, String itemType, String group) throws Exception {
        return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "invitedGroups", new AttributeValue(group), false, DELETE);
    }

    public static DatabaseAction updateAddOwnedGroup(String id, String itemType, String group, boolean ifWithCreate)
            throws Exception {
        if (ifWithCreate) {
            return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "ownedGroups", null, true, ADD);
        }
        else {
            return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "ownedGroups", new AttributeValue(group), false, ADD);
        }
    }

    public static DatabaseAction updateRemoveOwnedGroup(String id, String itemType, String group) throws Exception {
        return new UpdateDatabaseAction(getPrimaryKey(itemType, id), "ownedGroups", new AttributeValue(group), false, DELETE);
    }
}
