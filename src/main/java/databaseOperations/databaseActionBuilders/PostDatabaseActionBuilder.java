...
public class PostDatabaseActionBuilder {
    ...
    public static DatabaseAction updateAddPicturePath(String id, String picturePath) throws Exception {
        return new UpdateDatabaseAction(getPrimaryKey(id), "picturePaths", new AttributeValue(picturePath), false, ADD);
    }

    public static DatabaseAction updateRemovePicturePath(String id, String picturePath) throws Exception {
        return new UpdateDatabaseAction(getPrimaryKey(id), "picturePaths", new AttributeValue(picturePath), false, DELETE);
    }

    public static DatabaseAction updateAddVideoPath(String id, String videoPath) throws Exception {
        return new UpdateDatabaseAction(getPrimaryKey(id), "videoPaths", new AttributeValue(videoPath), false, ADD);
    }

    public static DatabaseAction updateRemoveVideoPath(String id, String videoPath) throws Exception {
        return new UpdateDatabaseAction(getPrimaryKey(id), "videoPaths", new AttributeValue(videoPath), false, DELETE);
    }

    public static DatabaseAction updateAddLike(String id) throws Exception {
        return new UpdateDatabaseAction(getPrimaryKey(id), "likes", new AttributeValue().withN("1"), false, ADD);
    }

    public static DatabaseAction updateRemoveLike(String id) throws Exception {
        return new UpdateDatabaseAction(getPrimaryKey(id), "likes", new AttributeValue().withN("1"), false, DELETE);
    }
